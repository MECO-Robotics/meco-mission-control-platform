...
// Keep disposable seed/tutorial/demo activity current without changing the
// checked-in fixture or mutating an already-started tutorial session.
export function createTutorialSnapshot(now = new Date()): PlatformSnapshot {
  ...
  // Seasons frame the activity and retain the full current month below.
