...
> & {
  ...
  members: [
    ...
    {
      id: "demo-alex-morgan", name: "Alex Morgan (Demo)", email: "demo.alex.morgan@example.com",
      role: "lead", elevated: false, disciplineId: "design",
      seasonId: "default-season", activeSeasonIds: ["default-season"],
      plannedWeeklyAttendanceHours: 8, plannedAttendanceDays: ["tuesday", "thursday", "saturday"],
      plannedAttendanceNotes: "Fictional demo member for roster previews.",
    },
    {
      id: "demo-sam-rivera", name: "Sam Rivera (Demo)", email: "demo.sam.rivera@example.com",
      role: "student", elevated: false, disciplineId: "manufacturing",
      seasonId: "default-season", activeSeasonIds: ["default-season"],
      plannedWeeklyAttendanceHours: 6, plannedAttendanceDays: ["tuesday", "thursday"],
      plannedAttendanceNotes: "Fictional demo member for roster previews.",
    },
    {
      id: "demo-taylor-chen", name: "Taylor Chen (Demo)", email: "demo.taylor.chen@example.com",
      role: "student", elevated: false, disciplineId: "assembly",
      seasonId: "default-season", activeSeasonIds: ["default-season"],
      plannedWeeklyAttendanceHours: 6, plannedAttendanceDays: ["tuesday", "thursday"],
      plannedAttendanceNotes: "Fictional demo member for roster previews.",
    },
    {
      id: "demo-jamie-patel", name: "Jamie Patel (Demo)", email: "demo.jamie.patel@example.com",
      role: "student", elevated: false, disciplineId: "electrical",
      seasonId: "default-season", activeSeasonIds: ["default-season"],
      plannedWeeklyAttendanceHours: 8, plannedAttendanceDays: ["tuesday", "thursday", "saturday"],
      plannedAttendanceNotes: "Fictional demo member for roster previews.",
    },
    {
      id: "demo-casey-brooks", name: "Casey Brooks (Demo)", email: "demo.casey.brooks@example.com",
      role: "lead", elevated: false, disciplineId: "programming",
      seasonId: "default-season", activeSeasonIds: ["default-season"],
      plannedWeeklyAttendanceHours: 10, plannedAttendanceDays: ["tuesday", "thursday", "saturday"],
      plannedAttendanceNotes: "Fictional demo member for roster previews.",
    },
    {
      id: "demo-quinn-parker", name: "Quinn Parker (Demo)", email: "demo.quinn.parker@example.com",
      role: "student", elevated: false, disciplineId: "testing",
      seasonId: "default-season", activeSeasonIds: ["default-season"],
      plannedWeeklyAttendanceHours: 6, plannedAttendanceDays: ["tuesday", "thursday"],
      plannedAttendanceNotes: "Fictional demo member for roster previews.",
    },
    {
      id: "demo-riley-dawson", name: "Riley Dawson (Demo)", email: "demo.riley.dawson@example.com",
      role: "student", elevated: false, disciplineId: "communications",
      seasonId: "default-season", activeSeasonIds: ["default-season"],
      plannedWeeklyAttendanceHours: 4, plannedAttendanceDays: ["tuesday", "thursday"],
      plannedAttendanceNotes: "Fictional demo member for roster previews.",
    },
    {
      id: "demo-jordan-ellis", name: "Jordan Ellis (Demo)", email: "demo.jordan.ellis@example.com",
      role: "student", elevated: false, disciplineId: "planning",
      seasonId: "default-season", activeSeasonIds: ["default-season"],
      plannedWeeklyAttendanceHours: 4, plannedAttendanceDays: ["tuesday", "thursday"],
      plannedAttendanceNotes: "Fictional demo member for roster previews.",
    },
